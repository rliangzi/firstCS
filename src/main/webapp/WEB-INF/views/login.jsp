...
<head>
	...
	<title>欢迎使用activiti流程引擎管理工具</title>
	<script>
    ...
    <div id="loginContainer" class="login-center">
		...
		<form action="${ctx }/user/logon" method="get">
			<table>
				<tr>
					...
					<td><input id="username" name="username" class="login-input" autofocus="autofocus" placeholder="请输入用户名" /></td>
				</tr>
				<tr>
					<td style="text-align: right;">密码：</td>
					<td><input id="password" name="password" type="password" class="login-input" placeholder="请输入密码" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
        ...
        <div>
            <div style="float:left; width: 50%;">
                <h5>组件版本信息</h5>
                <ul>
                    <li>Activiti版本：5.19.0</li>
                    <li>Spring版本：4.1.6.RELEASE</li>
